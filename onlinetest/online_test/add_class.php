...
<header id="header" class="fixed-top d-flex align-items-center">
 ...
 <?php
              ...
              <li><a class="nav-link scrollto active" aria-current="page" href="add_class.php">Add Class</a></li>
...
<input type="text" name="class_name" class="form-control" placeholder="Enter the Class Name" required />
<br />
