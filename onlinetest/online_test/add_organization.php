...
<header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto active" href="add_organization.php">Add Organization</a></li>
          <li><a class="nav-link scrollto" href="add_user.php">Add User</a></li>
          <li><a class="nav-link scrollto" href="add_class.php">Add Class</a></li>
          <li><a class="nav-link scrollto " href="add_subject.php">Add Subject</a></li>
          <li><a class="nav-link scrollto" href="add_question.php">Add Question</a></li>
	...
	<li class="dropdown"><a href="#"><span>Reports</span> <i class="bi bi-chevron-down"></i></a>
          ...
          <li><a class="nav-link scrollto" href="take_exam.php">Take Exam</a></li>
...
<form action="add_organization_process.php" method="POST">
<label>Organization Name:</label><br />

<input type="text" name="org_name" class="form-control" placeholder="Enter the Organization Name" required />
 
<br />


<label>Organization Email:</label><br />
<input type="email" class="form-control" name="org_email" placeholder="Enter the Organization Email" required />
<br />

<label>Password:</label><br />
<input type="password" class="form-control" name="org_password" placeholder="Enter the Password" required />
<br />

<button type="submit" class="btn btn-primary" name="submit">Register Organization</button>
</form>
</div>
</div>
