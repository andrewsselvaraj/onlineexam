...
<nav id="navbar" class="navbar">
        <ul>
              ...
              <li><a class="nav-link scrollto active" aria-current="page" href="add_user.php">Add User</a></li>
...
<?php 
$sql ="SELECT * FROM org_info WHERE pk_org_id IN (SELECT user_org_id FROM user_info WHERE user_email='$_SESSION[login_admin_user_email]' AND user_status='A') OR (org_updated_by = '$_SESSION[login_admin_user_email]' AND org_status = 'A')";     
//echo $sql;                           
...
<input type="text" name="new_user_name" class="form-control" placeholder="Enter the User Name" required />
<br />

<label>New User's Email:</label><br />
<input type="text" name="new_user_email" class="form-control" placeholder="Enter the User Email" required />
<br />

<label>New User's Password:</label><br />
<input type="password" name="new_user_password" class="form-control" placeholder="Enter the User Password" required />
<br />

<label>New user's Role: </label><br />
